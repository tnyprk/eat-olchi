...
const { address, phone, website, social } = storeData;
            ...
            <div className="h-full w-full max-w-[1800px] mx-auto px-6 py-6 overflow-y-auto print:overflow-visible print:h-auto">
                ...
                <div className="border-t border-stone-200 flex flex-row justify-between items-center gap-6 print:mt-auto">
                    ...
                    <div className="flex flex-row items-center gap-6 text-stone-700 text-sm">
                        ...
                        <a href={`https://${website}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 hover:text-[#B13613] transition-colors">
                            <Globe className="w-4 h-4" />
                            <span>{website}</span>
                        </a>
                        <a href={`tel:${phone}`} className="flex items-center gap-1.5 hover:text-[#B13613] transition-colors">
                            <Phone className="w-4 h-4" />
                            <span>{formatPhone(phone)}</span>
                        </a>
                        <a href={`https://instagram.com/${social.instagram}`} target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 hover:text-[#B13613] transition-colors">
